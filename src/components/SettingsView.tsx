  ...
  return (
    <div className="w-full max-w-3xl mx-auto pb-12">
      <header className="mb-8">
        <h2 className="font-bold text-3xl text-[#26332C]">设置</h2>
        <p className="text-sm text-[#768078] mt-1">培育你的专注体验，定制你的数字避风港。</p>
      </header>
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-lg text-[#26332C]">专注设置</h3>
        </div>
        <div className="bg-[#FFFEF8] rounded-2xl shadow-xs border border-[#125238]/5 p-6 space-y-6">
          {/* Timer Length */}
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-sm text-[#26332C]">专注时长</p>
              <p className="text-xs text-[#768078]">标准深度专注时长</p>
            </div>
            <div className="flex items-center gap-3 bg-[#f6f4eb] rounded-xl p-1 border border-[#c0c9c1]/30">
              <button
          ...
          {/* Break Length */}
          <div className="flex justify-between items-center border-t border-[#c0c9c1]/20 pt-6">
            <div>
              <p className="font-bold text-sm text-[#26332C]">短休息时长</p>
              <p className="text-xs text-[#768078]">专注任务之间的间隔</p>
            </div>
            <div className="flex items-center gap-3 bg-[#f6f4eb] rounded-xl p-1 border border-[#c0c9c1]/30">
              <button
          ...
          <div className="flex justify-between items-center border-t border-[#c0c9c1]/20 pt-6">
            <div>
              <p className="font-bold text-sm text-[#26332C]">自动开始休息</p>
              <p className="text-xs text-[#768078]">专注结束后自动开始休息</p>
            </div>
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-lg text-[#26332C]">个性化</h3>
        </div>
        <div className="bg-[#FFFEF8] rounded-2xl shadow-xs border border-[#125238]/5 p-6 space-y-6">
          {/* Theme Selector */}
          <div>
            <p className="font-bold text-sm text-[#26332C] mb-3">主题设置</p>
              ...
              <button
                ...
                className={`flex flex-col items-center gap-2 p-3.5 rounded-xl border-2 transition-all ${
                  settings.theme === 'light'
                    ...
                    : 'border-[#c0c9c1]/30 text-[#768078] hover:border-[#125238]/30'
                }`}
              >
          ...
          {/* Ambient Sound */}
          <div className="border-t border-[#c0c9c1]/20 pt-6">
            <div className="flex justify-between items-center mb-3">
              <div>
                <p className="font-bold text-sm text-[#26332C]">环境音</p>
                <p className="text-xs text-[#768078]">大自然的声音景观</p>
              </div>
              <button
          ...
          <div className="border-t border-[#c0c9c1]/20 pt-6">
            <div className="flex justify-between items-center mb-3">
              <p className="font-bold text-sm text-[#26332C]">动画强度</p>
            ...
            />
            <div className="flex justify-between text-[10px] text-[#768078] uppercase font-bold tracking-wider">
              <span>无</span>
              <span>减弱</span>
              <span>自然</span>
            </div>
          ...
          <div className="flex justify-between items-center border-t border-[#c0c9c1]/20 pt-6">
            <div>
              <p className="font-bold text-sm text-[#26332C]">声音提醒</p>
              <p className="text-xs text-[#768078]">开启任务状态的声音警报</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
      ...
      <section>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-bold text-lg text-[#26332C]">数据管理</h3>
        </div>
        <div className="bg-[#FFFEF8] rounded-2xl shadow-xs border border-[#125238]/5 p-6 space-y-6">
          <button
            onClick={onExportCSV}
          ...
          >
            <div>
              <p className="font-bold text-sm text-[#26332C] group-hover:text-[#125238] transition-colors">
                导出专注数据
              </p>
              <p className="text-xs text-[#768078]">以 CSV 格式下载你的专注历程</p>
            </div>
            <span className="material-symbols-outlined text-[#768078] group-hover:text-[#125238] group-hover:translate-x-1 transition-all">
              chevron_right
            </span>
          </button>
          ...
          <button
            ...
            className="w-full flex justify-between items-center text-left group border-t border-[#c0c9c1]/20 pt-6 cursor-pointer"
          >
            <div>
              <p className="font-bold text-sm text-[#ba1a1a]">重置所有数据</p>
              <p className="text-xs text-[#768078]">清空本地所有历史森林与习惯记录</p>
            </div>
