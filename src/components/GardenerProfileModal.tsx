  ...
  return (
    ...
    >
      <div
        ...
        className="bg-[#FFFEF8] rounded-3xl p-6 max-w-xs sm:max-w-sm w-full shadow-2xl border border-[#c0c9c1]/30 max-h-[90vh] overflow-y-auto flex flex-col my-auto relative animate-in zoom-in-95 duration-200"
      >
        <div className="flex justify-between items-center mb-4 shrink-0">
          ...
          <button
            onClick={onClose}
            className="text-[#768078] hover:text-[#26332C] p-1 rounded-full hover:bg-black/5 transition-colors cursor-pointer"
          >
        ...
        <div className="flex flex-col items-center text-center py-2 shrink-0">
          ...
          <h4 className="font-extrabold text-xl text-[#26332C]">{userName}</h4>
        </div>

        {/* Avatar picker */}
        {showAvatarPicker && (
          <div className="mt-3 mb-2 p-3 bg-[#f0eee5] rounded-2xl border border-[#c0c9c1]/20 animate-in fade-in zoom-in-95 duration-150">
            <p className="text-[11px] font-bold text-[#768078] text-center mb-2">选择头像</p>
        ...
        <div className="grid grid-cols-2 gap-2.5 my-4">
          <div className="p-3 bg-[#f0eee5] rounded-2xl text-center border border-[#c0c9c1]/20">
            <p className="text-xs text-[#768078] font-medium">累计完成树木</p>
            <p className="text-xl font-extrabold text-[#125238] mt-1">{totalTreesCount} 棵</p>
          </div>
          <div className="p-3 bg-[#f0eee5] rounded-2xl text-center border border-[#c0c9c1]/20">
            <p className="text-xs text-[#768078] font-medium">生态头衔</p>
        ...
        <div className="space-y-2 mt-auto shrink-0">
          ...
          <button
            ...
            className="w-full py-2 bg-[#f0eee5] text-[#ba1a1a] rounded-xl font-bold text-xs hover:bg-[#ba1a1a]/10 active:scale-98 transition-all cursor-pointer"
          >
            退出登录
          </button>
        </div>
